...
<content>
	<div class="container">
		<div class="row text-center">
			<h2>Ôn thi THPT Quốc Gia môn Hóa Học</h2>
		</div>
			...
			<div class="col-sm-8">
				...
				<div class="row choosen-courses">
						<table class="table">
								<tbody>
								  <tr>
									<td><p>Lựa chọn theo Khóa học</p><p><i>(theo mức điểm kỳ vọng)</i></p></td>
									<td>
								  ...
								  <tr>
									<td><p>Lọc bài giảng</p><p><i>(Theo kết quả)</i></p></td>
									<td>
								...
								<div id="accordion" class="accordion">
									<div class="card mb-0">
										<div class="card-header collapsed" data-toggle="collapse" href="#collapse1">
											<a class="card-title text-upper-case">
