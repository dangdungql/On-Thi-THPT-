...
<div class="container">	  
		...
		<div class="modal fade" id="logIn" role="dialog">
			...
			<div class="modal-content">
				...
				<button type="button" class="btn btn-background-blue" data-dismiss="modal">Close</button>
				</div>
			</div>				
			</div>
		</div>
		...
		<div class="modal fade" id="signIn" role="dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
				<button type="button" class="btn btn-background-white-blue" data-dismiss="modal">Close</button>
				</div>
			</div>				
			</div>
		</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-6 col-xl-8 header-user">
						...
						<button type="button" class="btn btn-background-red btn-style mrgr-10 " data-toggle="modal" data-target="#logIn">Đăng Nhập</button>
						<button type="button" class="btn btn-background-white btn-style" data-toggle="modal" data-target="#signIn">Đăng ký</button>
					</div>
				</div>
			</div> 
		</div>
					    ...
					    <ul class="navbar-nav">
							<li class="nav-item dropdown">
									...
									<div class="dropdown-menu" aria-labelledby="navbarDropdown">
										...
										<div class="dropdown-divider"></div>
										<a class="dropdown-item" href="./addListlesson.php">Vật lý</a>
										<div class="dropdown-divider"></div>
